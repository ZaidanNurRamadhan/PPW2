            ...
            <div class="card-body">
                <form action="{{ route('store') }}" method="post" class="form p-5">
                    ...
                    <div class="mb-3 d-flex justify-content-between">
                        <label class="fs-5" for="name">Name</label>
                        <div class="w-75">
                    ...
                    <div class="mb-3 d-flex justify-content-between">
                        <label class="fs-5" for="password_confirmation">Confirm Password</label>
                        <div class="w-75">
                    ...
                    <div class="row mt-5">
                        <input type="submit" class="col-md-3 offset-md-5 btn btn-primary fs-3" value="Register">
                    </div>
                </form>
            </div>
        </div>
